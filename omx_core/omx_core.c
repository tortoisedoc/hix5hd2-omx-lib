...
/* macros */
#define MAX_COMP_INSTANCES                 2
#define MAX_ROLE_NUM                       20
#define MAX_TABLE_SIZE                     MAX_ROLE_NUM
#define MAX_COMP_NAME_LEN                  50
...
static ComponentTable  g_ComponentTable[MAX_TABLE_SIZE];
static OMX_U32         g_TableCount = 0;

static OMX_PTR         pModules[MAX_ROLE_NUM] = {0};
...
static char *tComponentName[MAX_ROLE_NUM][2] = {
	...
	{OMX_VDEC_COMPONENT_NAME,  OMX_COMPONENTROLES_H264},
	{OMX_VDEC_COMPONENT_NAME,  OMX_COMPONENTROLES_VC1},
	{OMX_VDEC_COMPONENT_NAME,  OMX_COMPONENTROLES_MPEG2},
	{OMX_VDEC_COMPONENT_NAME,  OMX_COMPONENTROLES_MPEG4},
	{OMX_VDEC_COMPONENT_NAME,  OMX_COMPONENTROLES_H263},
	{OMX_VDEC_COMPONENT_NAME,  OMX_COMPONENTROLES_DIVX3},
	{OMX_VDEC_COMPONENT_NAME,  OMX_COMPONENTROLES_VP8},
	{OMX_VDEC_COMPONENT_NAME,  OMX_COMPONENTROLES_VP6},
	{OMX_VDEC_COMPONENT_NAME,  OMX_COMPONENTROLES_WMV},
	{OMX_VDEC_COMPONENT_NAME,  OMX_COMPONENTROLES_AVS},
	{OMX_VDEC_COMPONENT_NAME,  OMX_COMPONENTROLES_SORENSON},
	{OMX_VDEC_COMPONENT_NAME,  OMX_COMPONENTROLES_RV},
		    ...
		    for (j = 0; j < CurRoleNum; j ++)
		    {
		        if (!strcmp(g_ComponentTable[j].name, tComponentName[i][0]))
			    {
		            ...
		            if (tComponentName[i][1] != NULL)
		            {
		                ...
		                g_ComponentTable[j].pHandle[g_ComponentTable[j].nRoles] = NULL; //initilize the pHandle element
